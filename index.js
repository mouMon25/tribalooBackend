...
app.get("/popularinwomen", async (req, res) => {
  let products = await Product.find({ category: "delights" });
  let arr = products.splice(0, 4);
  console.log("Popular In Delights");
  res.send(arr);
});
...
//updating to delights
app.get("/fix-category", async (req, res) => {
  const result = await Product.updateMany(
    { category: "women" },
    { $set: { category: "delights" } }
  );
